...
impl Attrs {
    ...
    /// Forge patch: faint on/off (SGR 2 / SGR 22).
...
impl BufWrite for Attrs {
    ...
    fn write_buf(&self, buf: &mut Vec<u8>) {
        ...
        // Forge patch: faint on/off. Off emits 22 like bold-off does;
        // per ECMA-48, 22 resets both bold and faint intensity.

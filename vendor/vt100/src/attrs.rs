...
// Forge patch: faint (SGR 2) support; upstream 0.15.2 drops it, which
// renders agent ghost/prediction text full-bright. See FORGE-PATCHES.md.
...
impl Attrs {
    ...
    /// Forge patch: whether the cell renders faint (SGR 2).
    pub fn dim(&self) -> bool {
        self.mode & TEXT_MODE_DIM != 0
    }

    /// Forge patch: set faint rendering (SGR 2 / SGR 22).
    ...
    pub fn write_escape_code_diff(
        ...
        // Forge patch: carry faint through escape-code diffs.
